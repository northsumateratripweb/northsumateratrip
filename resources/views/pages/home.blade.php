...
{{-- Welcome Text Section (Strategic & Space-efficient) --}}
<section class="bg-white pt-4 pb-0 md:pt-10">
    <div class="max-w-7xl mx-auto px-4 text-center">
        @if($badgeText = \App\Models\Setting::get('hero_badge_text'))
        ...
        <h1 class="text-xl md:text-5xl lg:text-7xl font-black text-gray-900 uppercase tracking-tighter leading-none mb-2 md:mb-4">
            {{ \App\Models\Setting::get('hero_title', 'Jelajahi Sumatera Utara') }}
        </h1>
        <p class="text-gray-400 text-[8px] md:text-xs font-bold uppercase tracking-[0.25em] max-w-2xl mx-auto">
            {{ \App\Models\Setting::get('hero_subtitle', 'Sewa Mobil & Paket Wisata Terbaik.') }}
        </p>
    </div>
</section>
...
<section class="py-10 md:py-16 bg-white overflow-hidden" id="popular-trips">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-xl md:text-3xl font-black text-gray-900 uppercase tracking-tighter">{{ __('ui.popular_trip') }}</h2>
                <div class="w-12 h-1 bg-blue-600 mt-2"></div>
            </div>
            <a href="{{ route('products.index') }}" class="text-[10px] font-black text-blue-600 hover:text-gray-900 uppercase tracking-widest transition-colors">
                {{ __('ui.view_all_packages') }} &rarr;
            </a>
        </div>
                        ...
                        <div class="flex items-center justify-between mt-3">
                            <div class="flex items-center gap-1.5">
                                <div class="flex text-amber-400 text-[8px] md:text-xs">
                                    @for($i = 1; $i <= 5; $i++)
                                        <i class="{{ $i <= ($product->rating ?? 5) ? 'fas' : 'far' }} fa-star"></i>
                                    @endfor
                                </div>
...
<section class="py-12 md:py-16 bg-gray-50 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-xl md:text-3xl font-black text-gray-900 uppercase tracking-tighter">{{ __('ui.car_rental_title') }}</h2>
                <div class="w-12 h-1 bg-blue-600 mt-2"></div>
            </div>
...
<section class="py-12 md:py-16 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-xl md:text-3xl font-black text-gray-900 uppercase tracking-tighter">{{ __('ui.rental_pkg_title') }}</h2>
                <div class="w-12 h-1 bg-blue-600 mt-2"></div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="text-center group">
                ...
                <h3 class="text-sm font-black uppercase tracking-widest text-gray-900">{{ $feature['title'] }}</h3>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="bg-blue-600 rounded-[2.5rem] p-8 md:p-16 text-center shadow-2xl shadow-blue-200">
            ...
            <div class="mt-10">
                <a href="{{ route('custom-request.create') }}" class="inline-block px-12 py-5 bg-white text-blue-600 font-black text-sm rounded-full hover:bg-gray-100 transition-all uppercase tracking-widest">
...
<section class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4">
        <div class="flex items-center justify-between mb-12">
            <h2 class="text-2xl font-black text-gray-900 uppercase tracking-tighter">{{ __('ui.latest_blog') }}</h2>
            <a href="{{ route('blog.index') }}" class="text-sm font-bold text-blue-600 hover:text-gray-900 transition-colors uppercase tracking-widest">
                {{ __('ui.view_all_blog') }} &rarr;
            </a>
        </div>
