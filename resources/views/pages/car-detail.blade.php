        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div class="lg:col-span-8">
                <div class="mb-14">
                    ...
                    @php $allImages = $carRental->all_image_urls; @endphp
                    <!-- Main Image -->
                    <div class="relative group rounded-2xl overflow-hidden bg-white border border-slate-100 cursor-zoom-in" onclick="openLightbox('{{ $allImages[0] ?? $carRental->image_url }}', '{{ $carRental->name }}')">
                        <div class="aspect-video overflow-hidden rounded-2xl">
                            <img src="{{ $allImages[0] ?? $carRental->image_url }}" alt="{{ $carRental->name }}" class="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-110" loading="lazy">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-4 gap-4 mt-6">
                        ...
                        <div class="aspect-video rounded-xl md:rounded-2xl overflow-hidden border border-slate-100 cursor-zoom-in shadow-sm hover:shadow-md transition-shadow" onclick="openLightbox('{{ $galleryUrl }}', '{{ $carRental->name }}')">
                            <img src="{{ $galleryUrl }}"
                                 alt="{{ $carRental->name }}"
