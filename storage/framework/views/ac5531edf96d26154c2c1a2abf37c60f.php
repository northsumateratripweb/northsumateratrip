...
<?php $__env->startSection('title', $product->name . ' - NorthSumateraTrip'); ?>
...
<?php $__env->startSection('canonical', route('products.show', [$product->category->slug, $product->slug])); ?>
...
<div class="pt-28 pb-4">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex items-center gap-2 text-xs font-medium text-slate-400">
            ...
            <a href="<?php echo e(route('products.category', $product->category->slug)); ?>" class="hover:text-blue-600 transition-colors"><?php echo e($product->category->name); ?></a>
            <i class="fas fa-chevron-right text-[8px] text-slate-300"></i>
            <span class="text-slate-700 font-semibold"><?php echo e($product->name); ?></span>
        </nav>
    </div>
</div>
...
<section class="py-8 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
                <!-- Main Image -->
                <div class="relative rounded-2xl overflow-hidden mb-4 cursor-zoom-in" onclick="openLightbox(document.getElementById('main-image').src, '<?php echo e($product->name); ?>')">
                    <img id="main-image" 
            ...
            <div>
                ...
                <!-- Title -->
                <h1 class="text-2xl md:text-4xl font-bold text-slate-900 dark:text-white tracking-tight mb-4"><?php echo e($product->name); ?></h1>
                        ...
                        <div x-show="step === 3" x-cloak class="booking-step p-5 space-y-4">
                            ...
                            <div class="bg-white rounded-xl border border-slate-200 p-4 text-sm space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold text-slate-800 text-right max-w-[55%]"><?php echo e($product->name); ?></span>
                                </div>
                                <div class="flex justify-between">
                            ...
                            <a id="wa-direct-link"
                               href="https://wa.me/<?php echo e(\App\Models\Setting::get('whatsapp_number','6281298622143')); ?>?text=<?php echo e(urlencode('Halo, saya ingin tanya tentang paket '.$product->name)); ?>"
                               target="_blank"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="tab-content">
            ...
            <div id="tab-itinerary" class="tab-pane active">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->itinerary_text): ?>
                <div class="bg-white rounded-2xl border border-slate-100 p-6 prose max-w-none">
                    <?php echo $product->itinerary_text; ?>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-lg hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-300 group">
                        ...
                        <div class="p-4">
                            ...
                            <h3 class="font-semibold text-slate-900 text-sm line-clamp-2 hover:text-blue-600 transition-colors">
                                <a href="<?php echo e(route('products.show', ['category' => $related->category->slug, 'product' => $related->slug])); ?>">
            ...
            <div id="tab-notes" class="tab-pane hidden">
                <div class="bg-white rounded-2xl border border-slate-100 p-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->notes): ?>
                    <div class="prose max-w-none text-slate-600">
                        <?php echo nl2br(e($product->notes)); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->includes && count($product->includes) > 0): ?>
                    <div class="mt-6">
                        <h4 class="font-semibold text-slate-900 mb-3">Termasuk:</h4>
                        <ul class="list-disc list-inside text-slate-600 space-y-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $product->includes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $include): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->excludes && count($product->excludes) > 0): ?>
                    <div class="mt-6">
                        <h4 class="font-semibold text-slate-900 mb-3">Tidak Termasuk:</h4>
                        <ul class="list-disc list-inside text-slate-600 space-y-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $product->excludes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exclude): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
