...
<?php $__env->startSection('title', __('ui.custom_trip') . ' — ' . ($settings['site_name'] ?? 'NorthSumateraTrip')); ?>
<?php $__env->startSection('meta_description', __('ui.custom_trip_desc')); ?>
    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-8 mt-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div>
                    <h2 class="text-xl font-bold text-slate-900 dark:text-white tracking-tight mb-5"><?php echo e(__('ui.why_custom_title')); ?></h2>
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4 p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
                            <div class="w-10 h-10 rounded-xl <?php echo e($why['bg']); ?> flex items-center justify-center <?php echo e($why['text']); ?> flex-shrink-0">
                                <i class="fas <?php echo e($why['icon']); ?> text-sm"></i>
                            </div>
                            <div>
                                <p class="font-semibold text-slate-900 dark:text-white text-sm"><?php echo e($why['title']); ?></p>
                                <p class="text-slate-500 text-xs leading-relaxed mt-0.5"><?php echo e($why['desc']); ?></p>
                            </div>
                        </div>
                ...
                <div class="bg-slate-900 dark:bg-slate-800 rounded-2xl p-6 text-white">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [['num' => '500+', 'label' => 'Trip Done'], ['num' => '99%', 'label' => 'Puas'], ['num' => '50+', 'label' => 'Destinasi'], ['num' => '24/7', 'label' => 'Support']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <p class="text-2xl font-extrabold text-blue-400 leading-none"><?php echo e($stat['num']); ?></p>
                            <p class="text-xs text-slate-400 mt-0.5"><?php echo e($stat['label']); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-900/5 overflow-hidden"
                    ...
                    <div class="border-b border-slate-100 dark:border-slate-800 px-8 pt-7 pb-0">
                        <div class="flex items-center gap-0 mb-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [__('ui.step_contact'), __('ui.step_trip'), __('ui.step_preferences')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $stepLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex-1 flex flex-col items-center group cursor-pointer" @click="goStep(<?php echo e($i + 1); ?>)">
                                <div class="flex items-center w-full">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i > 0): ?><div class="flex-1 h-0.5 transition-colors duration-300" :class="step > <?php echo e($i); ?> ? 'bg-blue-600' : 'bg-slate-100 dark:bg-slate-800'"></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 flex-shrink-0"
                                         :class="step === <?php echo e($i + 1); ?> ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/30' : (step > <?php echo e($i + 1); ?> ? 'bg-green-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400')">
                                        <span x-show="step <= <?php echo e($i + 1); ?>"><?php echo e($i + 1); ?></span>
                                        <i x-show="step > <?php echo e($i + 1); ?>" class="fas fa-check text-xs"></i>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i < 2): ?><div class="flex-1 h-0.5 transition-colors duration-300" :class="step > <?php echo e($i + 1); ?> ? 'bg-blue-600' : 'bg-slate-100 dark:bg-slate-800'"></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <p class="text-xs font-semibold mt-2 transition-colors duration-200"
                                   :class="step === <?php echo e($i + 1); ?> ? 'text-blue-600' : 'text-slate-400'">
                    ...
                    <form @submit.prevent="submitForm" class="p-8">
                        ...
                        <div x-show="step === 1" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-6"><?php echo e(__('ui.step_contact')); ?></h3>
                            <div class="space-y-5">
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.order_name')); ?> *</label>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.order_phone')); ?> *</label>
                        ...
                        <div x-show="step === 2" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-6"><?php echo e(__('ui.step_trip')); ?></h3>
                            <div class="space-y-5">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.order_date')); ?></label>
                                    ...
                                    <div>
                                        <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.trip_duration_label')); ?> *</label>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.num_persons_label')); ?> *</label>
                                    ...
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [1, 2, 3, 4, 5, 6, 10, 15, 20]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" @click="form.num_persons = <?php echo e($n); ?>"
                                                class="px-3 py-1 rounded-lg text-xs font-semibold transition-all border"
                                                :class="form.num_persons === <?php echo e($n); ?> ? 'bg-blue-600 text-white border-blue-600' : 'bg-slate-50 text-slate-500 border-slate-200 hover:border-blue-300'">
                                            <?php echo e($n); ?>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.destinations_label')); ?></label>
                                    <textarea x-model="form.destinations" rows="3"
                                              placeholder="<?php echo e(__('ui.destinations_placeholder')); ?>"
                        ...
                        <div x-show="step === 3" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-6"><?php echo e(__('ui.step_preferences')); ?></h3>
                            <div class="space-y-6">
                                
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3"><?php echo e(__('ui.budget_label')); ?></label>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $budgetOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" @click="form.budget_range = '<?php echo e($value); ?>'"
                                                class="px-4 py-3 rounded-xl text-xs font-semibold text-left transition-all border"
                                                :class="form.budget_range === '<?php echo e($value); ?>' ? 'bg-blue-600 text-white border-blue-600 shadow-lg shadow-blue-500/20' : 'bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-blue-300'">
                                            <?php echo e($label); ?>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3"><?php echo e(__('ui.accommodation_label')); ?></label>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accommodationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" @click="form.accommodation_type = '<?php echo e($value); ?>'"
                                                class="px-4 py-3 rounded-xl text-xs font-semibold text-left transition-all border"
                                                :class="form.accommodation_type === '<?php echo e($value); ?>' ? 'bg-blue-600 text-white border-blue-600 shadow-lg shadow-blue-500/20' : 'bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-blue-300'">
                                            <?php echo e($label); ?>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3"><?php echo e(__('ui.transport_label')); ?></label>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $transportOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" @click="form.transport_type = '<?php echo e($value); ?>'"
                                                class="px-4 py-3 rounded-xl text-xs font-semibold text-left transition-all border"
                                                :class="form.transport_type === '<?php echo e($value); ?>' ? 'bg-blue-600 text-white border-blue-600 shadow-lg shadow-blue-500/20' : 'bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-blue-300'">
                                            <?php echo e($label); ?>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(__('ui.special_requests_label')); ?></label>
                                    <textarea x-model="form.special_requests" rows="3"
                                              placeholder="<?php echo e(__('ui.special_requests_ph')); ?>"
                                              class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none leading-relaxed"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mt-8 pt-6 border-t border-slate-100 dark:border-slate-800">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button x-show="step === 3" type="submit"
                                    ...
                                    <span x-text="submitting ? 'Mengirim...' : '<?php echo e(__('ui.submit_custom')); ?>'"></span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div x-show="success"
                        ...
                        <h3 class="text-2xl font-extrabold text-slate-900 dark:text-white mb-2"><?php echo e(__('ui.custom_success_title')); ?></h3>
                        <p class="text-slate-500 text-sm mb-8 max-w-xs leading-relaxed"><?php echo e(__('ui.custom_success_msg')); ?></p>
...
function customRequestForm() {
    return {
        ...
        async submitForm() {
            ...
            try {
                const res = await fetch('<?php echo e(route('custom-request.store')); ?>', {
                    method: 'POST',
                    headers: {
