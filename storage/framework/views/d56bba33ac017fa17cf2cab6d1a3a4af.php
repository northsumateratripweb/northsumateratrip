...
<head>
    ...
    <meta property="twitter:image" content="<?php echo $__env->yieldContent('og_image', ''); ?>">

    <link rel="icon" type="image/x-icon" href="<?php echo e(!empty($settings['site_favicon']) ? asset('storage/' . $settings['site_favicon']) : asset('favicon.ico')); ?>">
