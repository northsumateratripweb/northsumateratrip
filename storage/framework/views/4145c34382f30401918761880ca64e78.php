...
<?php $__env->startSection('title', 'Hubungi Kami - NorthSumateraTrip'); ?>
...
<div class="pt-36 md:pt-48 pb-20 max-w-7xl mx-auto px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
            <div class="space-y-5 mb-10">
                ...
                <div class="flex items-start gap-4 p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.04] hover:-translate-y-0.5">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm mb-1.5"><?php echo e($settings['whatsapp_display'] ?? '+62 812-9862-2143'); ?></p>
                        <a href="https://wa.me/<?php echo e($settings['whatsapp_number'] ?? '6281298622143'); ?>" target="_blank" 
                ...
                <div class="flex items-start gap-4 p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.04] hover:-translate-y-0.5">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm mb-1.5"><?php echo e($settings['site_email'] ?? 'hello@northsumateratrip.com'); ?></p>
                        <a href="mailto:<?php echo e($settings['site_email'] ?? 'hello@northsumateratrip.com'); ?>" 
                           class="text-blue-600 hover:text-blue-700 text-xs font-bold inline-flex items-center gap-1 group">
                ...
                <div class="flex items-start gap-4 p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.04] hover:-translate-y-0.5">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm"><?php echo e($settings['site_address'] ?? 'Sumatera Utara, Indonesia'); ?></p>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="flex gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['facebook_url'] ?? false): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['instagram_url'] ?? false): ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['tiktok_url'] ?? false): ?>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-7 md:p-8">
            ...
            <form action="<?php echo e(route('contact.submit')); ?>" method="POST" data-ajax>
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>"
                               class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>"
                               class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone" value="<?php echo e(old('phone')); ?>"
                               class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="4"
                                  class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Tulis pesan Anda..."><?php echo e(old('message')); ?></textarea>
    ...
    <div class="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div class="space-y-3">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl border transition-all duration-300"
                 :class="openFaq === <?php echo e($i); ?> ? 'border-blue-200 dark:border-blue-800 shadow-lg shadow-blue-900/[0.04]' : 'border-slate-100 dark:border-slate-800'">
                <button class="w-full px-6 py-4.5 text-left font-bold text-sm flex justify-between items-center gap-4 transition-colors"
                        :class="openFaq === <?php echo e($i); ?> ? 'text-blue-600' : 'text-slate-700 dark:text-slate-300'"
                        @click="openFaq = openFaq === <?php echo e($i); ?> ? null : <?php echo e($i); ?>">
                    ...
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-300"
                         :class="openFaq === <?php echo e($i); ?> ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 rotate-180' : 'bg-slate-50 dark:bg-slate-800 text-slate-400'">
                        <i class="fas fa-chevron-down text-xs"></i>
                    </div>
                </button>
                <div x-show="openFaq === <?php echo e($i); ?>" x-collapse x-cloak
