...
<?php $component->withAttributes([]); ?>
    ...
    <div style="display:flex; flex-wrap:wrap; gap:1rem; align-items:flex-end; margin-bottom:1.5rem; padding:1rem; background:white; border-radius:0.75rem; box-shadow:0 1px 3px rgba(0,0,0,.1); border:1px solid #e5e7eb;">
        <div style="display:flex; flex-direction:column; gap:0.25rem;">
            ...
            <select wire:model.live="selectedYear"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->getAvailableYears(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div style="display:flex; gap:0.5rem; margin-left:auto; flex-wrap:wrap; align-items:center;">
            ...
            <a href="<?php echo e(route('laporan.pesanan.csv', ['tahun' => $selectedYear, 'bulan' => $selectedMonth])); ?>"
               target="_blank"
               style="display:inline-flex; align-items:center; gap:0.5rem; padding:0.4rem 1rem; border-radius:0.5rem; background:#4b5563; color:white; font-size:0.875rem; font-weight:600; text-decoration:none;">
                ...
                CSV <?php echo e($selectedMonth ? 'Bulan Ini' : 'Tahunan'); ?>

            </a>
            <a href="<?php echo e(route('laporan.pesanan.excel', ['tahun' => $selectedYear, 'bulan' => $selectedMonth])); ?>"
               target="_blank"
               style="display:inline-flex; align-items:center; gap:0.5rem; padding:0.4rem 1rem; border-radius:0.5rem; background:#16a34a; color:white; font-size:0.875rem; font-weight:600; text-decoration:none;">
                ...
                Excel <?php echo e($selectedMonth ? 'Bulan Ini' : 'Tahunan'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showImportForm): ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select wire:model="importTahun" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = range(now()->year, now()->year - 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div style="margin-bottom:0.5rem;">
        <h2 style="font-size:0.75rem; font-weight:700; color:#6b7280; text-transform:uppercase; letter-spacing:0.07em; margin-bottom:0.75rem;">
            📅 Ringkasan <?php echo e($selectedMonth ? $namaBulanLabel . ' ' . $selectedYear : 'Semua Bulan ' . $selectedYear); ?>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(160px, 1fr)); gap:0.75rem; margin-bottom:1rem;">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="background:white; border-radius:0.75rem; padding:1rem; box-shadow:0 1px 3px rgba(0,0,0,.08); border:1px solid #f3f4f6; display:flex; flex-direction:column; gap:0.25rem;">
                <span style="font-size:1.5rem;"><?php echo e($card['icon']); ?></span>
                <span style="font-size:0.72rem; color:#6b7280;"><?php echo e($card['label']); ?></span>
                <span style="font-size:1.25rem; font-weight:800; color:#111827;"><?php echo e($card['value']); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($monthly['csv_total'] > 0): ?>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(160px, 1fr)); gap:0.75rem; margin-bottom:1rem;">
            <div style="background:#faf5ff; border-radius:0.75rem; padding:1rem; border:1px solid #e9d5ff; display:flex; flex-direction:column; gap:0.25rem;">
                ...
                <span style="font-size:1.25rem; font-weight:800; color:#7e22ce;"><?php echo e($monthly['csv_total']); ?></span>
            </div>
            <div style="background:#faf5ff; border-radius:0.75rem; padding:1rem; border:1px solid #e9d5ff; display:flex; flex-direction:column; gap:0.25rem;">
                <span style="font-size:1.5rem;">💵</span>
                <span style="font-size:0.72rem; color:#9333ea;">Total Harga CSV</span>
                <span style="font-size:1.25rem; font-weight:800; color:#7e22ce;">Rp <?php echo e(number_format($monthly['csv_revenue'],0,',','.')); ?></span>
            </div>
            <div style="background:#faf5ff; border-radius:0.75rem; padding:1rem; border:1px solid #e9d5ff; display:flex; flex-direction:column; gap:0.25rem;">
                <span style="font-size:1.5rem;">🏔️</span>
                <span style="font-size:0.72rem; color:#9333ea;">Paket Trip (CSV)</span>
                <span style="font-size:1.25rem; font-weight:800; color:#7e22ce;"><?php echo e($monthly['csv_paket_trip']); ?></span>
            </div>
            <div style="background:#faf5ff; border-radius:0.75rem; padding:1rem; border:1px solid #e9d5ff; display:flex; flex-direction:column; gap:0.25rem;">
                <span style="font-size:1.5rem;">🚗</span>
                <span style="font-size:0.72rem; color:#9333ea;">Sewa Mobil (CSV)</span>
                <span style="font-size:1.25rem; font-weight:800; color:#7e22ce;"><?php echo e($monthly['csv_sewa_mobil']); ?></span>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(140px, 1fr)); gap:0.75rem; margin-bottom:1.5rem;">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statusCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="border-radius:0.75rem; padding:0.75rem 1rem; border:1px solid <?php echo e($s['border']); ?>; background:<?php echo e($s['bg']); ?>; display:flex; align-items:center; gap:0.75rem;">
                <span style="font-size:1.6rem; font-weight:800; color:<?php echo e($s['color']); ?>;"><?php echo e($s['value']); ?></span>
                <span style="font-size:0.78rem; font-weight:600; color:<?php echo e($s['color']); ?>;"><?php echo e($s['label']); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div style="margin-bottom:1.5rem; padding:1.25rem 1.5rem; background:linear-gradient(135deg, #1e40af, #4f46e5); border-radius:0.75rem; color:white; box-shadow:0 4px 16px rgba(30,64,175,.25);">
        <h2 style="font-size:0.8rem; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; margin-bottom:0.85rem; opacity:0.8;">📊 Ringkasan Tahunan <?php echo e($selectedYear); ?></h2>
        <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(130px, 1fr)); gap:1rem;">
            <div><div style="font-size:1.5rem; font-weight:800;"><?php echo e($yearly['total']); ?></div><div style="font-size:0.75rem; opacity:0.75;">Pesanan Web</div></div>
            <div><div style="font-size:1rem; font-weight:800;">Rp <?php echo e(number_format($yearly['revenue'],0,',','.')); ?></div><div style="font-size:0.75rem; opacity:0.75;">Pendapatan Web</div></div>
            <div><div style="font-size:1.5rem; font-weight:800;"><?php echo e($yearly['tour']); ?></div><div style="font-size:0.75rem; opacity:0.75;">Paket Wisata</div></div>
            <div><div style="font-size:1.5rem; font-weight:800;"><?php echo e($yearly['rental']); ?></div><div style="font-size:0.75rem; opacity:0.75;">Paket Rental</div></div>
            <div><div style="font-size:1.5rem; font-weight:800;"><?php echo e($yearly['car']); ?></div><div style="font-size:0.75rem; opacity:0.75;">Rental Mobil</div></div>
            <div><div style="font-size:1.5rem; font-weight:800;"><?php echo e($yearly['csv_total']); ?></div><div style="font-size:0.75rem; opacity:0.75;">Data CSV</div></div>
            <div><div style="font-size:1rem; font-weight:800;">Rp <?php echo e(number_format($yearly['csv_revenue'],0,',','.')); ?></div><div style="font-size:0.75rem; opacity:0.75;">Harga CSV</div></div>
        </div>
    </div>

    
    <?php $chartData = $this->getMonthlyChartData(); ?>
    <div style="background:white; border-radius:0.75rem; box-shadow:0 1px 3px rgba(0,0,0,.08); border:1px solid #f3f4f6; padding:1.25rem; margin-bottom:1.5rem;">
        <h3 style="font-weight:700; color:#374151; margin-bottom:1rem;">📈 Grafik Pesanan Per Bulan — <?php echo e($selectedYear); ?></h3>
        <div style="display:flex; align-items:flex-end; gap:4px; height:160px; overflow-x:auto;">
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $chartData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="display:flex; flex-direction:column; align-items:center; gap:4px; flex:1; min-width:40px;">
                <span style="font-size:10px; font-weight:700; color:#2563eb;"><?php echo e($row['total'] ?: ''); ?></span>
                <div style="width:100%; display:flex; flex-direction:column-reverse; gap:2px;">
                    <div style="width:100%; border-radius:2px 2px 0 0; background:<?php echo e(($selectedMonth && (int)$selectedMonth === ($index+1)) ? '#3b82f6' : '#93c5fd'); ?>; height:<?php echo e(max(2, ($row['orders'] / $maxTotal) * 140)); ?>px;"
                         title="<?php echo e($row['month']); ?>: <?php echo e($row['orders']); ?> pesanan web"></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['csv_orders'] > 0): ?>
                    <div style="width:100%; border-radius:2px 2px 0 0; background:#c084fc; height:<?php echo e(max(2, ($row['csv_orders'] / $maxTotal) * 140)); ?>px;"
                         title="<?php echo e($row['month']); ?>: <?php echo e($row['csv_orders']); ?> data CSV"></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <span style="font-size:9px; color:#9ca3af; text-align:center;"><?php echo e(substr($row['month'], 0, 3)); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <div style="background:white; border-radius:0.75rem; box-shadow:0 1px 3px rgba(0,0,0,.08); border:1px solid #f3f4f6; overflow:hidden; margin-bottom:1.5rem;">
        <div style="padding:1rem; border-bottom:1px solid #f3f4f6; display:flex; align-items:center; gap:0.75rem;">
            <h3 style="font-weight:700; color:#374151; margin:0;">
                📲 Pesanan Website —
                <?php echo e($selectedMonth ? ($namaBulan[$selectedMonth] ?? $selectedMonth) . ' ' . $selectedYear : 'Semua ' . $selectedYear); ?>

            </h3>
            <span style="margin-left:auto; font-size:0.875rem; color:#9ca3af;"><?php echo e($orders->count()); ?> pesanan</span>
        </div>
        <div style="overflow-x:auto;">
            <table style="width:100%; font-size:0.85rem; border-collapse:collapse;">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        <td class="px-4 py-3 text-gray-400 text-xs"><?php echo e($i + 1); ?></td>
                        <td class="px-4 py-3 text-gray-600 dark:text-gray-300 whitespace-nowrap text-xs"><?php echo e($order->created_at->format('d M Y')); ?></td>
                        <td class="px-4 py-3"><span class="font-mono text-xs text-blue-600 dark:text-blue-400"><?php echo e($order->transaction_id ?? '-'); ?></span></td>
                        <td class="px-4 py-3"><span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($tipe['class']); ?>"><?php echo e($tipe['label']); ?></span></td>
                        <td class="px-4 py-3 text-gray-700 dark:text-gray-200 max-w-[200px] truncate" title="<?php echo e($item); ?>"><?php echo e($item); ?></td>
                        <td class="px-4 py-3">
                            <div class="text-sm font-medium text-gray-800 dark:text-gray-100"><?php echo e($order->customer_name); ?></div>
                        ...
                        <td class="px-4 py-3 text-gray-600 dark:text-gray-300 whitespace-nowrap text-xs">
                            <?php echo e($order->trip_date?->format('d M Y') ?? '-'); ?>
                        ...
                        <td class="px-4 py-3 text-center"><span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span></td>
                        <td class="px-4 py-3 text-center"><span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($payClass); ?>"><?php echo e($payLabel); ?></span></td>
                ...
                <tfoot class="bg-gray-50 dark:bg-gray-700/40">
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right font-bold text-green-600 dark:text-green-400 text-sm">
                            Rp <?php echo e(number_format($orders->where('status','!=','cancelled')->sum('total_price'), 0, ',', '.')); ?>
    ...
    <?php $tripImports = $this->getTripImportData(); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tripImports->count() > 0): ?>
    <div style="background:white; border-radius:0.75rem; box-shadow:0 1px 3px rgba(0,0,0,.08); border:1px solid #f3e8ff; overflow:hidden;">
        <div style="padding:1rem; border-bottom:1px solid #f3e8ff; background:#faf5ff; display:flex; align-items:center; gap:0.75rem;">
            ...
            <span style="margin-left:auto; font-size:0.875rem; color:#a855f7;"><?php echo e($tripImports->count()); ?> data</span>
        </div>
        <div style="overflow-x:auto;">
            <table style="width:100%; font-size:0.82rem; border-collapse:collapse;">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tripImports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="border-top:1px solid #faf5ff;">
                        <td style="padding:0.5rem 0.75rem; color:#9ca3af; font-size:0.72rem;"><?php echo e($i + 1); ?></td>
                        <td style="padding:0.5rem 0.75rem; color:#374151; font-size:0.72rem; white-space:nowrap;">
                            <?php echo e($trip->tanggal ? $trip->tanggal->format('d M Y') : '-'); ?>

                        </td>
                        <td style="padding:0.5rem 0.75rem;">
                            <div style="font-weight:600; color:#111827; font-size:0.82rem;"><?php echo e($trip->nama_pelanggan ?? '-'); ?></div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trip->status): ?><div style="font-size:0.7rem; color:#9ca3af;"><?php echo e($trip->status); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td style="padding:0.5rem 0.75rem; font-size:0.72rem; color:#6b7280;"><?php echo e($trip->nomor_hp ?? '-'); ?></td>
                        <td style="padding:0.5rem 0.75rem;">
                            <span style="display:inline-flex; align-items:center; padding:2px 8px; border-radius:99px; font-size:0.7rem; font-weight:600; <?php echo e(str_contains($trip->layanan ?? '', 'Trip') ? 'background:#f0fdf4; color:#15803d;' : 'background:#fff7ed; color:#c2410c;'); ?>">
                                <?php echo e($trip->layanan ?? '-'); ?>

                            </span>
                        </td>
                        <td style="padding:0.5rem 0.75rem; font-size:0.72rem; color:#4b5563;"><?php echo e($trip->nama_driver ?? '-'); ?></td>
                        <td style="padding:0.5rem 0.75rem; font-size:0.72rem; color:#4b5563;">
                            <?php echo e($trip->jenis_mobil ?? $trip->plat_mobil ?? '-'); ?>

                        </td>
                        <td style="padding:0.5rem 0.75rem; text-align:center; font-weight:700; color:#374151; font-size:0.72rem;"><?php echo e($trip->jumlah_hari ?? 1); ?></td>
                        <td style="padding:0.5rem 0.75rem; text-align:center;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trip->drone): ?>
                        ...
                        <td style="padding:0.5rem 0.75rem; text-align:right; font-weight:600; color:#111827; white-space:nowrap; font-size:0.72rem;">
                            <?php echo e($trip->harga > 0 ? 'Rp ' . number_format($trip->harga, 0, ',', '.') : '-'); ?>

                        </td>
                        <td style="padding:0.5rem 0.75rem; text-align:right; font-size:0.72rem; color:#6b7280; white-space:nowrap;">
                            <?php echo e($trip->deposit > 0 ? 'Rp ' . number_format($trip->deposit, 0, ',', '.') : '-'); ?>

                        </td>
                        <td style="padding:0.5rem 0.75rem; text-align:right; font-size:0.72rem; color:#6b7280; white-space:nowrap;">
                            <?php echo e($trip->pelunasan > 0 ? 'Rp ' . number_format($trip->pelunasan, 0, ',', '.') : '-'); ?>
                ...
                <tfoot style="background:#faf5ff;">
                    <tr>
                        ...
                        <td style="padding:0.75rem; text-align:right; font-weight:700; color:#7e22ce; font-size:0.875rem;">Rp <?php echo e(number_format($tripImports->sum('harga'),0,',','.')); ?></td>
                        <td style="padding:0.75rem; text-align:right; font-weight:700; color:#9333ea; font-size:0.75rem;">Rp <?php echo e(number_format($tripImports->sum('deposit'),0,',','.')); ?></td>
                        <td style="padding:0.75rem; text-align:right; font-weight:700; color:#9333ea; font-size:0.75rem;">Rp <?php echo e(number_format($tripImports->sum('pelunasan'),0,',','.')); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\PROYEK\WEBSITE WISATA\WISATA SEDERHANA\northsumateratrip.com\resources\views/filament/pages/laporan-pesanan.blade.php ENDPATH**/ ?>