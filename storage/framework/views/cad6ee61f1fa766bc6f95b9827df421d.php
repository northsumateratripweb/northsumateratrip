...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($isItinerary ? 'Itinerary' : 'Invoice'); ?> – <?php echo e($itemName); ?></title>
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* ══ HEADER ═══════════════════════════════════════════ */
        .hdr { background: <?php echo e($primaryColor); ?>; padding: 36px 50px 28px; color:#fff; position:relative; overflow:hidden; }
        ...
        .sec-title {
            ...
            text-transform:uppercase; color:<?php echo e($primaryColor); ?>;
        ...
        .dv-a{ color:<?php echo e($primaryColor); ?>; font-size:12.5px; }
...
<div class="hdr">
    <table class="hdr-t">
        <tr>
            <td class="hdr-l">
                <div class="brand"><?php echo e(strtoupper($companyName)); ?></div>
                <div class="brand-sub"><?php echo e(strtoupper($siteSlogan)); ?></div>
            </td>
            <td class="hdr-r">
                <div class="doc-type"><?php echo e($isItinerary ? 'Itinerary Preview' : 'Official Invoice'); ?></div>
                <div class="doc-num"><?php echo e($invoiceNo); ?></div>
            </td>
        </tr>
    </table>
</div>
...
<div class="meta">
    <div class="meta-t">
        <div class="meta-c">
            ...
            <div class="mv"><?php echo e($issuedAt); ?></div>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isItinerary): ?>
        <div class="meta-c">
            <div class="ml">ID Pemesanan</div>
            <div class="mv"><?php echo e($invoiceNo); ?></div>
        </div>

        <div class="meta-c">
            <div class="ml">Status</div>
            <div class="mv">
                <span class="badge" style="background:<?php echo e($statusBg); ?>;color:<?php echo e($statusFg); ?>;"><?php echo e($statusLabel); ?></span>
            </div>
        </div>
        ...
        <div class="meta-c">
            ...
            <div class="mv">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isItinerary && $order->vehicle): ?>
                    🚗 Rental Mobil
                <?php elseif(!$isItinerary && $order->rentalPackage): ?>
                    🎫 Paket Rental
                <?php elseif(!$isItinerary && $order->product): ?>
                    🏔️ Paket Wisata
                <?php else: ?>
                    -
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<div class="body">
    ...
    <div class="grid2">
        <div class="col2 col2-l">
            <div class="dr">
                ...
                <div class="dv dv-a"><?php echo e($isItinerary ? 'Guest Customer' : $order->customer_name); ?></div>
            </div>
            <div class="dr">
                <div class="dl">WhatsApp / HP</div>
                <div class="dv"><?php echo e($isItinerary ? $waNumber : $order->customer_phone); ?></div>
            </div>
            <div class="dr">
                <div class="dl">Email</div>
                <div class="dv dv-s"><?php echo e($isItinerary ? $emailContact : $order->customer_email); ?></div>
            </div>
        </div>
        ...
        <div class="col2 col2-r">
            <div class="dr">
                ...
                <div class="dv dv-a">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isItinerary): ?>
                        Berdasarkan Request
                    <?php else: ?>
                        <?php echo e(Carbon::parse($order->trip_date)->translatedFormat('l, d F Y')); ?>
            ...
            <div class="dr">
                ...
                <div class="dv">
                    <?php echo e($itemQty); ?> Orang
                </div>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isItinerary && $order->flight_info): ?>
            <div class="dr">
                <div class="dl">Info Penerbangan</div>
                <div class="dv text-xs"><?php echo e($order->flight_info); ?></div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isItinerary && ($order->hotel_1 || $order->hotel_2 || $order->hotel_3 || $order->hotel_4)): ?>
    ...
    <div style="margin-bottom: 26px;">
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i=1; $i<=4; $i++): ?>
                ...
                <tr>
                    <td style="padding: 6px 0; border-bottom: 1px solid #f1f5f9; width: 100px; color: #64748b; font-weight: bold;">MALAM <?php echo e($i); ?></td>
                    <td style="padding: 6px 0; border-bottom: 1px solid #f1f5f9; font-weight: 700;"><?php echo e($order->$h); ?></td>
                </tr>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isItinerary && ($order->use_drone || $order->notes)): ?>
    ...
    <div style="background: #f8fafc; border-radius: 8px; padding: 12px; margin-bottom: 26px;">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->use_drone): ?>
        ...
        <div>
            ...
            <div style="font-style: italic; color: #475569;">"<?php echo e($order->notes); ?>"</div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <table class="ct">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="i-name"><?php echo e($itemName); ?></div>
                    <div class="i-desc"><?php echo e($itemMeta); ?></div>
                </td>
                <td style="text-align:right;font-weight:700;">
                    Rp <?php echo e(number_format($itemPrice, 0, ',', '.')); ?>
                ...
                <td style="text-align:right;font-weight:800;color:<?php echo e($primaryColor); ?>;">
    ...
    <div class="sw">
            ...
            <div class="snb">
                ...
                <div class="snb-p" style="line-height: 1.6;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bank1): ?>
                        <strong><?php echo e($bank1); ?>:</strong> <?php echo e(Setting::get('bank_account_1')); ?> (a/n <?php echo e(Setting::get('bank_holder_1')); ?>)<br>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bank2): ?>
                        <strong><?php echo e($bank2); ?>:</strong> <?php echo e(Setting::get('bank_account_2')); ?> (a/n <?php echo e(Setting::get('bank_holder_2')); ?>)<br>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qris && file_exists(storage_path('app/public/' . $qris))): ?>
                        <div style="margin-top: 10px; border: 1px dashed #cbd5e1; padding: 10px; border-radius: 8px; background: #fff; text-align: center;">
                            ...
                            ?>
                            <img src="data:image/png;base64,<?php echo e($qrisData); ?>" style="width: 120px; height: auto;">
                        </div>
                    <?php else: ?>
        ...
        <div class="sb">
            <div class="sr">
                ...
                <div class="sv2">Rp <?php echo e(number_format($totalPrice, 0, ',', '.')); ?></div>
            </div>
            <div class="sr">
            ...
            <div class="str">
                ...
                <div class="stv">Rp <?php echo e(number_format($totalPrice, 0, ',', '.')); ?></div>
            </div>
        </div>
    </div>
...
<div class="ftr">
    <div class="ftr-h">Terima kasih telah memilih <?php echo e($companyName); ?>! 🙏</div>
    <div class="ftr-s">
    ...
    <div class="ftr-ct">
        <div class="ftr-ci">📱 <?php echo e($waNumber); ?></div>
        <div class="ftr-sep">•</div>
        <div class="ftr-ci">✉️ <?php echo e($emailContact); ?></div>
        <div class="ftr-sep">•</div>
        <div class="ftr-ci">🌐 <?php echo e(request()->getHttpHost()); ?></div>
    </div>
</div>

</body>
</html>
<?php /**PATH D:\PROYEK\WEBSITE WISATA\WISATA SEDERHANA\northsumateratrip.com\resources\views\pages\invoice.blade.php ENDPATH**/ ?>