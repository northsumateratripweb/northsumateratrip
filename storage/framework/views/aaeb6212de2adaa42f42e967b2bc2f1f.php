...
<?php $__env->startSection('title', 'Daftar Paket Wisata Sumatera - NorthSumateraTrip'); ?>
<?php $__env->startSection('meta_description', 'Jelajahi berbagai pilihan paket wisata Sumatera Utara terbaik. Mulai dari paket trip harian, family gathering, hingga study tour.'); ?>
<?php $__env->startSection('canonical', route('packages')); ?>
    ...
    <div class="pt-36 md:pt-48 pb-32 max-w-7xl mx-auto px-6 lg:px-8">
               ...
               class="group flex flex-col sm:flex-row items-center justify-between gap-6 bg-gradient-to-r from-blue-700 to-blue-600 rounded-2xl px-7 py-6 shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300">
                <div class="flex items-center gap-5">
                    ...
                    <div class="text-center sm:text-left">
                        <p class="text-white font-extrabold text-lg leading-tight"><?php echo e(__('ui.custom_trip')); ?></p>
                        <p class="text-blue-100 text-sm mt-0.5"><?php echo e(__('ui.custom_trip_sub')); ?></p>
                    </div>
                </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($products->isEmpty()): ?>
            <div class="py-24 text-center bg-slate-50 dark:bg-slate-900/50 rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-800">
                ...
                <p class="text-slate-400 font-bold uppercase tracking-widest text-sm"><?php echo e(__('ui.no_packages')); ?></p>
            </div>
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('products.show', [$product->category?->slug ?? 'uncategorized', $product->slug])); ?>" class="group flex flex-col h-full bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-500 hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 overflow-hidden block cursor-pointer">
                        <!-- Image Container -->
                        <div class="relative h-52 overflow-hidden">
                            <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->translate('name')); ?>" class="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-110">
                            ...
                            <div class="absolute top-4 left-4 flex flex-col gap-2">
                                <span class="px-3.5 py-1.5 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-xl text-xs font-bold text-blue-600 dark:text-blue-400 border border-white/20 dark:border-slate-800 shadow-sm">
                                    <?php echo e($product->category?->name ?? 'Paket'); ?>
                        ...
                        <div class="flex-1 flex flex-col p-5">
                            ...
                            <div class="mt-auto flex items-center justify-between pt-4 border-t border-slate-50 dark:border-slate-800">
                                <div>
                                    ...
                                    <p class="text-lg font-extrabold text-slate-900 dark:text-white tracking-tight"><?php echo e(currency($product->price_min)); ?></p>
                                </div>
