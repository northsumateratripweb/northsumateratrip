...
<?php $__env->startSection('title', 'Rental Package - NorthSumateraTrip'); ?>
        ...
        <a href="<?php echo e(route('rental-package.show', $package->slug)); ?>" class="group flex flex-col h-full bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden transition-all duration-500 hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 block cursor-pointer">
            ...
            <div class="flex-1 flex flex-col p-5">
                <h3 class="font-bold text-slate-900 dark:text-white text-base mb-3 line-clamp-2 group-hover:text-blue-600 transition-colors leading-snug">
                    <?php echo e($package->translate('name')); ?>

                </h3>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($package->min_rental_days): ?>
                <div class="flex items-center gap-2 mb-4">
                    <span class="px-3 py-1 bg-slate-50 dark:bg-slate-800 rounded-lg text-xs font-medium text-slate-400 border border-slate-100 dark:border-slate-700">
                        Min <?php echo e($package->min_rental_days); ?> Hari
                    </span>
                </div>
                ...
                <div class="mt-auto flex items-center justify-between pt-4 border-t border-slate-50 dark:border-slate-800">
                    <div>
                        ...
                        <p class="text-lg font-extrabold text-slate-900 dark:text-white tracking-tight"><?php echo e(currency($package->price_per_day)); ?><span class="text-xs text-slate-400 font-medium ml-1">/hari</span></p>
                    </div>
