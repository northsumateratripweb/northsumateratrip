            ...
            <div class="relative overflow-hidden rounded-[2.5rem] border-2 border-dashed border-slate-200 dark:border-slate-800 p-12 md:p-24 text-center bg-white dark:bg-slate-900 shadow-sm mt-10">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="<?php echo e(route('car-rental')); ?>" class="w-full sm:w-auto px-8 py-3.5 bg-blue-600 text-white rounded-full text-xs font-black uppercase tracking-widest transition-all hover:scale-105 hover:bg-blue-700 shadow-lg shadow-blue-500/25">
                            Lihat Semua Armada
                        </a>
                        <a href="<?php echo e(route('contact')); ?>" class="w-full sm:w-auto px-8 py-3.5 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 rounded-full text-xs font-black uppercase tracking-widest transition-all hover:bg-slate-50">
                            Hubungi Admin
                        </a>
                    </div>
                </div>
