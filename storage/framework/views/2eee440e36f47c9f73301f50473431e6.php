...
<?php $__env->startSection('title', ($carRental->meta_title ?? $carRental->name) . ' - NorthSumateraTrip'); ?>
<?php $__env->startSection('canonical', route('car.detail', $carRental->slug)); ?>

<?php $__env->startPush('schema'); ?>
    <?php echo \App\Helpers\SchemaHelper::car($carRental); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div class="lg:col-span-8">
                <div class="mb-14">
                    ...
                    <h1 class="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white leading-tight tracking-tight mb-8"><?php echo e($carRental->name); ?></h1>

                    <?php $allImages = $carRental->all_image_urls; ?>
                    <!-- Main Image -->
                    <div class="relative group rounded-2xl overflow-hidden bg-white border border-slate-100 cursor-zoom-in" onclick="openLightbox('<?php echo e($allImages[0] ?? $carRental->image_url); ?>', '<?php echo e($carRental->name); ?>')">
                        <div class="aspect-video overflow-hidden rounded-2xl">
                            <img src="<?php echo e($allImages[0] ?? $carRental->image_url); ?>" alt="<?php echo e($carRental->name); ?>" class="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-110" loading="lazy">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-4 gap-4 mt-6">
                        ...
                        <div class="aspect-video rounded-xl md:rounded-2xl overflow-hidden border border-slate-100 cursor-zoom-in shadow-sm hover:shadow-md transition-shadow" onclick="openLightbox('<?php echo e($galleryUrl); ?>', '<?php echo e($carRental->name); ?>')">
                            <img src="<?php echo e($galleryUrl); ?>"
                                 alt="<?php echo e($carRental->name); ?>"
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.06]">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3"><?php echo e(__('ui.capacity')); ?></p>
                        <p class="text-xl font-extrabold text-slate-900 dark:text-white leading-none"><?php echo e($carRental->capacity); ?> Kursi</p>
                    </div>
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.06]">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3"><?php echo e(__('ui.price_per_day')); ?></p>
                        <p class="text-xl font-extrabold text-blue-600 dark:text-white leading-none"><?php echo e(currency($carRental->price_per_day)); ?></p>
                    </div>
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.06]">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3"><?php echo e(__('ui.transmission')); ?></p>
                        <p class="text-xl font-extrabold text-slate-900 dark:text-white leading-none capitalize"><?php echo e($carRental->transmission ?? 'Manual'); ?></p>
                    </div>
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.06]">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3"><?php echo e(__('ui.status')); ?></p>
                        <div class="flex items-center gap-2">
                            <span class="w-2.5 h-2.5 rounded-full <?php echo e($carRental->is_available ? 'bg-emerald-500' : 'bg-rose-500'); ?>"></span>
                            <span class="text-xl font-extrabold text-slate-900 dark:text-white leading-none"><?php echo e($carRental->is_available ? __('ui.available') : __('ui.booked')); ?></span>
                        </div>
                    </div>
                </div>

                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->fuel_type || $carRental->year): ?>
                <div class="grid grid-cols-2 gap-4 mb-16">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->fuel_type): ?>
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3"><?php echo e(__('ui.fuel_type')); ?></p>
                        <p class="text-lg font-extrabold text-slate-900 dark:text-white capitalize"><?php echo e($carRental->fuel_type); ?></p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->year): ?>
                    <div class="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3"><?php echo e(__('ui.year')); ?></p>
                        <p class="text-lg font-extrabold text-slate-900 dark:text-white"><?php echo e($carRental->year); ?></p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="space-y-16">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($carRental->features) && count($carRental->features) > 0): ?>
                    <section>
                        <h2 class="text-base font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-8 flex items-center gap-3">
                            ...
                            <?php echo e(__('ui.features')); ?>

                        </h2>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carRental->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-4 p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:border-blue-100">
                                    ...
                                    <span class="font-medium text-slate-600 dark:text-slate-400"><?php echo e($feature); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </section>
                    ...
                    <section>
                        <h2 class="text-base font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-8 flex items-center gap-3">
                            <span class="w-8 h-0.5 bg-blue-600"></span>
                            <?php echo e(__('ui.rental_facilities')); ?>

                        </h2>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [__('ui.driver_fuel_included'), __('ui.full_ac_audio'), __('ui.clean_fragrant_unit'), __('ui.travel_insurance'), __('ui.24_hour_service'), __('ui.airport_transfer')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-4 p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:border-blue-100">
                                    <div class="w-10 h-10 bg-blue-50 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-blue-600 dark:text-blue-400">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path></svg>
                                    </div>
                                    <span class="font-medium text-slate-600 dark:text-slate-400"><?php echo e($service); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </section>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($carRental->includes) && count($carRental->includes) > 0): ?>
                    <section>
                        <h2 class="text-base font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-8 flex items-center gap-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carRental->includes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $include): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-3 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-100 dark:border-emerald-800/40">
                                    ...
                                    <span class="font-bold text-slate-700 dark:text-slate-300"><?php echo e($include); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </section>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->description): ?>
                    <section>
                        <h2 class="text-base font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-8 flex items-center gap-3">
                            <span class="w-8 h-0.5 bg-blue-600"></span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->terms): ?>
                    <section>
                        <h2 class="text-base font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-8 flex items-center gap-3">
                            <span class="w-8 h-0.5 bg-amber-500"></span>
                            <?php echo e(__('ui.terms')); ?>
                        ...
                        <div class="p-6 bg-amber-50 dark:bg-amber-900/20 rounded-2xl border border-amber-100 dark:border-amber-800/40">
                            <div class="prose prose-amber dark:prose-invert max-w-none text-slate-600 dark:text-slate-400">
                                <?php echo nl2br(e($carRental->terms)); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($relatedCarRentals) && $relatedCarRentals->isNotEmpty()): ?>
                <div class="mt-20">
                    <h2 class="text-base font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-8 flex items-center gap-3">
                        <span class="w-8 h-0.5 bg-blue-600"></span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $relatedCarRentals->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('car.detail', $related->slug)); ?>" class="group flex items-center gap-5 p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/[0.06] hover:border-blue-100">
                            <div class="w-20 h-16 rounded-xl overflow-hidden flex-shrink-0">
                                <img src="<?php echo e($related->image_url); ?>" alt="<?php echo e($related->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1"><?php echo e($related->capacity); ?> Kursi &bull; <?php echo e($related->transmission ?? 'Manual'); ?></p>
                                <h3 class="font-bold text-slate-900 dark:text-white line-clamp-1 group-hover:text-blue-600 transition-colors"><?php echo e($related->name); ?></h3>
                                <p class="text-sm font-extrabold text-blue-600 mt-1"><?php echo e(currency($related->price_per_day)); ?><span class="text-slate-400 text-xs font-medium"><?php echo e(__('ui.per_day')); ?></span></p>
                            </div>
                ...
                <div class="sticky top-44">
                    <div class="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-100 dark:border-slate-800 shadow-lg shadow-blue-900/[0.06]">
                        ...
                        <div class="flex items-center justify-between mb-8">
                            <div>
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2"><?php echo e(__('ui.starting_from')); ?></p>
                                <p class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight"><?php echo e(currency($carRental->price_per_day)); ?><span class="text-sm text-slate-400 font-medium ml-1"><?php echo e(__('ui.per_day')); ?></span></p>
                            </div>

                        </div>

                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->price_per_12_hours || $carRental->price_with_driver): ?>
                        <div class="mb-8 space-y-3">
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider"><?php echo e(__('ui.pricing_options')); ?></p>
                            <div class="space-y-2">
                                <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                                    <span class="text-xs font-bold text-slate-600 dark:text-slate-400"><?php echo e(__('ui.price_per_day_24h')); ?></span>
                                    <span class="text-sm font-extrabold text-blue-600"><?php echo e(currency($carRental->price_per_day)); ?></span>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->price_per_12_hours): ?>
                                <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                                    <span class="text-xs font-bold text-slate-600 dark:text-slate-400"><?php echo e(__('ui.price_12h')); ?></span>
                                    <span class="text-sm font-extrabold text-blue-600"><?php echo e(currency($carRental->price_per_12_hours)); ?></span>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->price_with_driver): ?>
                                <div class="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/30 rounded-2xl border border-blue-100 dark:border-blue-800">
                                    <span class="text-xs font-bold text-blue-600 dark:text-blue-400"><?php echo e(__('ui.price_with_driver')); ?></span>
                                    <span class="text-sm font-extrabold text-blue-600"><?php echo e(currency($carRental->price_with_driver)); ?></span>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        ...
                        <form action="<?php echo e(route('car.order', $carRental->slug)); ?>" method="POST" class="space-y-5" id="bookingForm" x-data="carBooking()" x-on:submit.prevent="submitForm($event)">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <select name="quantity" id="rental_days" required class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl px-4 py-3 text-xs font-medium focus:border-blue-600 outline-none appearance-none">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 14; $i++): ?>
                            ...
                            <div class="p-6 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-100 dark:border-blue-800">
                                ...
                                <div class="text-xl font-extrabold text-blue-600" id="total_price_display">
                                    <?php echo e(currency($carRental->price_per_day)); ?>
                            ...
                            <button type="submit" x-bind:disabled="loading" class="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-xs uppercase tracking-wider transition-all shadow-lg shadow-blue-500/20 flex items-center justify-center gap-3">
                                ...
                                <span x-text="loading ? 'Memproses...' : '<?php echo e(__('ui.order_car')); ?>'"></span>
                        ...
                        <script>
                            (function() {
                                ...
                                const basePrice = <?php echo e($carRental->price_per_day); ?>;
                                const pricingDetails = <?php echo json_encode($carRental->pricing_details ?? []); ?>;
                        ...
                        <div class="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
                            <p class="text-xs font-medium text-slate-400 uppercase tracking-wider mb-4"><?php echo e(__('ui.need_help')); ?></p>
                            <a href="https://wa.me/<?php echo e(preg_replace('/\D/', '', \App\Models\Setting::get('whatsapp_number', '628123456789'))); ?>?text=Halo, saya ingin tanya sewa <?php echo e(urlencode($carRental->name)); ?>" target="_blank" class="text-xs font-bold text-[#25D366] uppercase tracking-wider hover:opacity-80 transition-all flex items-center justify-center gap-2">
