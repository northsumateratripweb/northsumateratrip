...
<?php $__env->startSection('title', ($blog->meta_title ?? $blog->translate('title')) . ' - NorthSumateraTrip'); ?>
<?php $__env->startSection('meta_description', $blog->meta_description ?? $blog->translate('excerpt')); ?>
<?php $__env->startSection('og_image', $blog->image_url); ?>
<?php $__env->startSection('canonical', route('blog.show', $blog->slug)); ?>
...
<?php $__env->startPush('schema'); ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "BlogPosting",
      "headline": "<?php echo e($blog->translate('title')); ?>",
      "image": "<?php echo e($blog->image_url); ?>",
      "author": {
        "@type": "Organization",
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "<?php echo e(asset('storage/' . ($settings['site_logo'] ?? ''))); ?>"
        }
      },
      "datePublished": "<?php echo e($blog->created_at->toIso8601String()); ?>",
...
<section class="relative pt-36 pb-20 overflow-hidden bg-white dark:bg-slate-950">
    <div class="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div class="flex items-center gap-4 mb-8">
            <a href="<?php echo e(route('blog.index')); ?>" class="text-xs font-bold text-blue-600 uppercase tracking-wider bg-blue-50 dark:bg-blue-900/30 px-3 py-1.5 rounded-lg border border-blue-100 dark:border-blue-800 transition-all hover:bg-blue-100">
                Guided Trips
            </a>
            <div class="w-1 h-1 rounded-full bg-slate-300 dark:bg-slate-700"></div>
            <span class="text-xs font-bold text-slate-400 uppercase tracking-widest"><?php echo e($blog->read_time); ?></span>
        </div>
        ...
        <div class="flex flex-wrap items-center justify-between gap-6 pt-8 border-t border-slate-100 dark:border-slate-800">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e($blog->share_url['facebook']); ?>" target="_blank" class="w-9 h-9 flex items-center justify-center bg-slate-50 dark:bg-slate-900 text-slate-400 hover:text-blue-600 border border-slate-100 dark:border-slate-800 rounded-xl transition-all hover:scale-110 active:scale-90">
                    <i class="fab fa-facebook-f text-sm"></i>
                </a>
                <a href="<?php echo e($blog->share_url['twitter']); ?>" target="_blank" class="w-9 h-9 flex items-center justify-center bg-slate-50 dark:bg-slate-900 text-slate-400 hover:text-sky-500 border border-slate-100 dark:border-slate-800 rounded-xl transition-all hover:scale-110 active:scale-90">
                    <i class="fab fa-twitter text-sm"></i>
                </a>
                <a href="<?php echo e($blog->share_url['whatsapp']); ?>" target="_blank" class="w-9 h-9 flex items-center justify-center bg-slate-50 dark:bg-slate-900 text-slate-400 hover:text-green-500 border border-slate-100 dark:border-slate-800 rounded-xl transition-all hover:scale-110 active:scale-90">
...
<?php $allImages = $blog->all_image_urls; ?>
<!-- Featured Image Full Width -->
<section class="max-w-7xl mx-auto px-6 mb-20">
    <div class="aspect-[21/9] rounded-2xl overflow-hidden shadow-xl shadow-blue-900/[0.06] border border-slate-100 dark:border-slate-800 cursor-zoom-in" onclick="openLightbox('<?php echo e($allImages[0] ?? $blog->image_url); ?>', '<?php echo e($blog->translate('title')); ?>')">
        <img src="<?php echo e($allImages[0] ?? $blog->image_url); ?>" alt="<?php echo e($blog->translate('title')); ?>" class="w-full h-full object-cover">
    </div>
</section>
...
<section class="bg-white dark:bg-slate-950 pb-24">
    <div class="max-w-4xl mx-auto px-6">
        <div class="blog-content prose prose-lg prose-slate dark:prose-invert max-w-none">
            <?php echo $blog->translate('content'); ?>
        ...
        <div class="mt-20 pt-20 border-t border-slate-100 dark:border-slate-800">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_slice($allImages, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleryImageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="aspect-video rounded-2xl overflow-hidden border border-slate-100 hover:shadow-lg hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 cursor-zoom-in" onclick="openLightbox('<?php echo e($galleryImageUrl); ?>', '<?php echo e($blog->translate('title')); ?>')">
                    <img src="<?php echo e($galleryImageUrl); ?>" alt="<?php echo e($blog->translate('title')); ?>" class="w-full h-full object-cover">
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group flex flex-col h-full">
                <div class="relative aspect-[4/3] rounded-2xl overflow-hidden mb-5 border border-slate-100 group-hover:shadow-lg group-hover:shadow-blue-900/[0.06] transition-all duration-500">
                    <img src="<?php echo e($related->image_url); ?>" alt="<?php echo e($related->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                </div>
                ...
                <span class="text-xs font-bold text-slate-400 uppercase tracking-widest"><?php echo e($related->read_time); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
