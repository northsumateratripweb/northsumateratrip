        ...
        <div class="swiper heroSwiper relative overflow-hidden rounded-[1.25rem] md:rounded-[2.5rem] shadow-2xl group border-[4px] md:border-[8px] border-white ring-1 ring-gray-100">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide aspect-[2.1/1] md:aspect-[3/1] relative overflow-hidden">
                    <img src="<?php echo e(\App\Models\Product::resolveImagePath($image, 'settings')); ?>" alt="Hero" class="w-full h-full object-cover shadow-inner">
                </div>
...
<section class="py-16 bg-gray-900 overflow-hidden">
    ...
    <div class="text-center mt-8">
        <a href="<?php echo e(route('gallery')); ?>" class="text-[10px] font-black text-white/50 hover:text-blue-400 uppercase tracking-[0.3em] transition-colors">- <?php echo e(__('ui.read_more')); ?> -</a>
    </div>
</section>
