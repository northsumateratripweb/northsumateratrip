...
<?php $__env->startSection('title', 'Inside Sumatera: Travel Guide & Insights - NorthSumateraTrip'); ?>
...
<section class="py-24 bg-white dark:bg-slate-950">
    <div class="max-w-7xl mx-auto px-6">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogs->count() > 0): ?>
            <?php $featured = $blogs->shift(); ?>
            
            <!-- Featured Post -->
            <a href="<?php echo e(route('blog.show', $featured->slug)); ?>" class="relative group mb-20 rounded-2xl overflow-hidden bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl shadow-blue-900/[0.04] block cursor-pointer">
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="aspect-[16/10] overflow-hidden">
                        <img src="<?php echo e($featured->image_url); ?>" alt="<?php echo e($featured->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                    </div>
                    <div class="p-8 md:p-12 flex flex-col justify-center">
                        <div class="flex items-center gap-3 mb-5">
                            ...
                            <span class="text-xs font-medium text-slate-400"><?php echo e($featured->read_time); ?></span>
                        </div>
                        ...
                        <p class="text-slate-500 dark:text-slate-400 mb-8 line-clamp-3 text-base font-medium leading-relaxed">
                            <?php echo e($featured->excerpt ?? strip_tags(Str::limit($featured->content, 200))); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <a href="<?php echo e(route('blog.show', $blog->slug)); ?>" class="group flex flex-col h-full bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden transition-all duration-500 hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 block cursor-pointer">
                    <div class="relative h-48 overflow-hidden">
                        <img src="<?php echo e($blog->image_url); ?>" alt="<?php echo e($blog->translate('title')); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out">
                    ...
                    <div class="flex-1 flex flex-col p-5">
                        <div class="flex items-center gap-3 mb-3">
                            <span class="text-xs font-medium text-blue-600"><?php echo e($blog->formatted_date); ?></span>
                            <div class="w-1 h-1 rounded-full bg-slate-200 dark:bg-slate-700"></div>
                            <span class="text-xs font-medium text-slate-400"><?php echo e($blog->read_time); ?></span>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->translate('excerpt')): ?>
                        <p class="text-slate-400 mb-4 line-clamp-2 text-sm leading-relaxed">
                            <?php echo e($blog->translate('excerpt')); ?>
...
<section class="py-20 bg-slate-50 dark:bg-slate-900 overflow-hidden relative">
    <div class="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <a href="https://instagram.com/<?php echo e(\App\Models\Setting::get('instagram_username', 'northsumateratrip')); ?>" 
           target="_blank"
