...
<?php $__env->startSection('title', $category->translate('name') . ' - NorthSumateraTrip'); ?>
<?php $__env->startSection('meta_description', $category->meta_description ?? $category->translate('description')); ?>
...
<div class="pt-32 md:pt-40 pb-20 max-w-7xl mx-auto px-6 lg:px-8">
    ...
    <div class="text-center mb-12 max-w-2xl mx-auto">
        <div class="inline-flex items-center gap-2 mb-5">
            ...
            <span class="text-xs font-bold text-blue-600 uppercase tracking-[0.2em]"><?php echo e($category->translate('name')); ?></span>
            <div class="w-8 h-0.5 bg-blue-600"></div>
        </div>
        ...
        <p class="text-slate-500 dark:text-slate-400 text-base leading-relaxed max-w-xl mx-auto">
            <?php echo e($category->translate('description')); ?>
        ...
        <a href="<?php echo e(route('products.show', ['category' => $product->category?->slug ?? 'uncategorized', 'product' => $product->slug])); ?>" class="group flex flex-col h-full bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 hover:shadow-lg hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 overflow-hidden">
            ...
            <div class="flex-1 flex flex-col p-5">
                ...
                <div class="flex items-center mb-4 mt-auto">
                    ...
                    <span class="text-slate-400 text-xs ml-2">(<?php echo e($product->review_count); ?>)</span>
                </div>
