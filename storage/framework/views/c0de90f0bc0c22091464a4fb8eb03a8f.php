...
<?php $__env->startPush('styles'); ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "<?php echo e($settings['site_name'] ?? 'NorthSumateraTrip'); ?>",
      "url": "<?php echo e(url('/')); ?>",
      "logo": "<?php echo e(asset('storage/' . ($settings['site_logo'] ?? ''))); ?>",
      "contactPoint": {
        "@type": "ContactPoint",
        "telephone": "<?php echo e($settings['whatsapp_number'] ?? ''); ?>",
        "contactType": "customer service"
      },
      "sameAs": [
        "<?php echo e($settings['facebook_url'] ?? '#'); ?>",
        "<?php echo e($settings['instagram_url'] ?? '#'); ?>",
        "<?php echo e($settings['tiktok_url'] ?? '#'); ?>"
      ]
    }
    </script>
    <script type="application/ld+json">
    {
      ...
      "@type": "LocalBusiness",
      "name": "<?php echo e($settings['site_name'] ?? 'NorthSumateraTrip'); ?>",
      "image": "<?php echo e(asset('storage/' . ($settings['site_logo'] ?? ''))); ?>",
      "@id": "<?php echo e(url('/')); ?>",
      "url": "<?php echo e(url('/')); ?>",
      "telephone": "<?php echo e($settings['whatsapp_number'] ?? ''); ?>",
      "address": {
...
<?php $__env->startSection('header_hero'); ?>
<?php 
...
<section class="overflow-hidden" id="header-hero">
    <div class="relative w-full h-[85vh] min-h-[480px] max-h-[720px] overflow-hidden group"
         x-data="heroSlider(<?php echo e($slideCount); ?>)" x-init="init()"
        ...
        <div class="hero-track flex h-full transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform"
             :style="'width:<?php echo e($slideCount * 100); ?>%; transform:translateX(-' + (current * (100 / <?php echo e($slideCount); ?>)) + '%)'">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $heroUrls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative h-full flex-shrink-0" style="width:<?php echo e(100 / $slideCount); ?>%">
                <img src="<?php echo e($url); ?>"
                     alt="Hero <?php echo e($i + 1); ?>"
            ...
            <div class="max-w-6xl mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-10">
                <div class="flex-1 min-w-0" x-show="shown"
                    ...
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.08] tracking-tight">
                        <?php echo e(\App\Models\Setting::get('hero_title', 'Jelajahi Keindahan Sumatera Utara')); ?>

                    </h1>
                    <p class="mt-3 text-sm sm:text-base md:text-lg text-white/75 font-medium max-w-xl leading-relaxed">
                        <?php echo e(\App\Models\Setting::get('hero_subtitle', 'Nikmati pengalaman wisata terbaik dengan layanan private trip eksklusif kami.')); ?>
                ...
                <div class="flex flex-row items-center gap-3 shrink-0" x-show="shown"
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" 
                       class="px-7 py-3.5 bg-white text-slate-900 font-bold text-sm rounded-2xl hover:bg-blue-50 transition-all duration-300 hover:scale-[1.03] shadow-xl shadow-black/10 whitespace-nowrap">
                        <?php echo e(__('ui.view_all_packages')); ?>

                    </a>
                    <a href="https://wa.me/<?php echo e(preg_replace('/\D/', '', \App\Models\Setting::get('whatsapp_number', '628123456789'))); ?>"
                       target="_blank"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slideCount > 1): ?>
        ...
        <div class="absolute bottom-5 left-1/2 -translate-x-1/2 flex gap-2 z-20">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $heroUrls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button @click="goTo(<?php echo e($i); ?>)" aria-label="Slide <?php echo e($i + 1); ?>"
                    class="h-2 rounded-full transition-all duration-500 cursor-pointer"
                    :class="current === <?php echo e($i); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($promotionBanners) && $promotionBanners->isNotEmpty()): ?>
<section class="py-6 bg-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 sm:grid-cols-<?php echo e($promotionBanners->count() >= 2 ? '2' : '1'); ?> gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $promotionBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative overflow-hidden rounded-2xl group shadow-sm hover:shadow-lg transition-shadow duration-500">
                ...
                <a href="<?php echo e($banner->link_url); ?>" <?php if(str_starts_with($banner->link_url, 'http')): ?> target="_blank" <?php endif; ?>>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <img src="<?php echo e(str_starts_with($banner->image_url ?? '', 'http') ? $banner->image_url : asset('storage/' . ($banner->image_url ?? ''))); ?>"
                    ...
                    <div class="absolute bottom-0 left-0 right-0 px-5 py-4 bg-gradient-to-t from-black/60 to-transparent rounded-b-2xl">
                        <p class="text-white font-bold text-sm"><?php echo e($banner->title); ?></p>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($banner->link_url): ?>
                </a>
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight"><?php echo e(__('ui.popular_trips')); ?></h2>
                <p class="text-slate-400 text-sm mt-1.5"><?php echo e(__('ui.popular_trips_sub')); ?></p>
            </div>
            <div class="flex items-center gap-3 shrink-0">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5 group">
                    <?php echo e(__('ui.view_all_packages')); ?>
        ...
        <div class="horizontal-scroll-container -mx-5 px-5 flex overflow-x-auto gap-5 pb-8 snap-x no-scrollbar">
            ...
            <a href="<?php echo e(route('products.show', ['category' => $product->category->slug, 'product' => $product->slug])); ?>" class="w-[280px] sm:w-[300px] flex-shrink-0 bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 group snap-start block cursor-pointer">
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-blue-600 font-extrabold text-base">
                            ...
                            ?>
                            <?php echo e(currency($priceMin)); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($priceMin != $priceMax): ?><span class="text-slate-300 font-normal"> – </span><?php echo e(currency($priceMax)); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                        <div class="flex items-center gap-1">
                            <div class="flex text-amber-400 text-[11px] gap-px">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="<?php echo e($i <= $product->rating ? 'fas' : 'far'); ?> fa-star"></i>
                                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-slate-300 text-[11px] font-medium">(<?php echo e($product->review_count ?? 0); ?>)</span>
                        </div>
                    </div>
                </div>
            </a>
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight"><?php echo e(__('ui.car_rental_title')); ?></h2>
                <p class="text-slate-400 text-sm mt-1.5"><?php echo e(__('ui.car_rental_sub')); ?></p>
            </div>
            <div class="flex items-center gap-3 shrink-0">
                <div class="flex items-center gap-1 mr-3">
                    <button type="button" class="scroll-prev w-9 h-9 border border-slate-200 rounded-xl flex items-center justify-center text-slate-300 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200 transition-all duration-200 opacity-30 pointer-events-none">
                ...
                <a href="<?php echo e(route('car-rental')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5 group">
                    <?php echo e(__('ui.view_all_cars')); ?>
        ...
        <div class="horizontal-scroll-container -mx-5 px-5 flex overflow-x-auto gap-5 pb-8 snap-x no-scrollbar">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carRentalProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('car.detail', $product->slug)); ?>" class="w-[280px] sm:w-[300px] flex-shrink-0 bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 group snap-start block cursor-pointer">
                ...
                <div class="p-5">
                    ...
                    <p class="text-blue-600 font-extrabold text-base">
                        <?php echo e(currency($product->price_per_day)); ?>
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight"><?php echo e(__('ui.rental_pkg_title')); ?></h2>
                <p class="text-slate-400 text-sm mt-1.5"><?php echo e(__('ui.rental_pkg_sub')); ?></p>
            </div>
            <div class="flex items-center gap-3 shrink-0">
                <div class="flex items-center gap-1 mr-3">
                    <button type="button" class="scroll-prev w-9 h-9 border border-slate-200 rounded-xl flex items-center justify-center text-slate-300 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200 transition-all duration-200 opacity-30 pointer-events-none">
                ...
                <a href="<?php echo e(route('rental-package')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5 group">
                    <?php echo e(__('ui.view_all_rental')); ?>
        ...
        <div class="horizontal-scroll-container -mx-5 px-5 flex overflow-x-auto gap-5 pb-8 snap-x no-scrollbar">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rentalPackageProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('rental-package.show', $product->slug)); ?>" class="w-[280px] sm:w-[300px] flex-shrink-0 bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 group snap-start block cursor-pointer">
                <div class="relative h-48 overflow-hidden bg-slate-50">
                    <img src="<?php echo e($product->image_url); ?>"
                         alt="<?php echo e($product->name); ?>"
                         class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight"><?php echo e(__('ui.gallery_title')); ?></h2>
                <p class="text-slate-400 text-sm mt-1.5"><?php echo e(__('ui.gallery_sub')); ?></p>
            </div>
            <a href="<?php echo e(route('gallery')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5 shrink-0 group">
                <?php echo e(__('ui.nav_gallery')); ?>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div class="rounded-2xl overflow-hidden group aspect-square cursor-zoom-in relative" onclick="openLightbox('<?php echo e($product->image_url); ?>', '<?php echo e($product->name); ?>')">
                <img src="<?php echo e($product->image_url); ?>"
                     alt="<?php echo e($product->name); ?>"
                     class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight"><?php echo e(__('ui.latest_blog')); ?></h2>
                <p class="text-slate-400 text-sm mt-1.5"><?php echo e(__('ui.blog_sub')); ?></p>
            </div>
            <a href="<?php echo e(route('blog.index')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5 shrink-0 group">
                <?php echo e(__('ui.view_all_blog')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <a href="<?php echo e(route('blog.show', $blog->slug)); ?>" class="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 group block cursor-pointer">
                <div class="relative h-48 overflow-hidden">
                ...
                <div class="p-5">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="text-[11px] font-bold text-blue-600 uppercase tracking-wider"><?php echo e($blog->formatted_date); ?></span>
                        <span class="w-1 h-1 rounded-full bg-slate-200"></span>
                        <span class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider"><?php echo e($blog->read_time); ?></span>
                    </div>
...
<section class="py-16 bg-slate-50/50 border-y border-slate-100">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <p class="text-[11px] font-bold text-slate-300 uppercase tracking-[0.2em] text-center mb-10"><?php echo e(__('ui.partners')); ?></p>
        <div class="flex items-center justify-center flex-wrap gap-10 md:gap-14">
            ...
            <div class="group">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <img src="<?php echo e(asset('images/partners/' . $partner->logo)); ?>"
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="text-center mb-14">
            ...
            <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mb-2"><?php echo e(__('ui.what_they_say')); ?></h2>
            <p class="text-slate-400 text-sm max-w-xl mx-auto"><?php echo e(__('ui.testimonials')); ?></p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 hover:shadow-xl hover:shadow-blue-900/[0.04] hover:-translate-y-0.5 transition-all duration-500 relative">
                ...
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        <h4 class="font-bold text-slate-900 text-sm"><?php echo e($testimonial->customer_name); ?></h4>
                        <div class="flex text-amber-400 text-[11px] mt-0.5 gap-px">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="<?php echo e($i <= $testimonial->rating ? 'fas' : 'far'); ?> fa-star"></i>
                            <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
                <p class="text-slate-500 text-sm leading-relaxed">“<?php echo e($testimonial->comment); ?>”</p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->product): ?>
                <div class="mt-5 pt-4 border-t border-slate-50">
                    <a href="<?php echo e(route('products.show', ['category' => $testimonial->product->category->slug, 'product' => $testimonial->product->slug])); ?>"
                       class="text-xs text-blue-600 hover:text-blue-700 font-semibold flex items-center gap-1 group">
                        ...
                        <?php echo e($testimonial->product->name); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($featuredHotels) && $featuredHotels->isNotEmpty()): ?>
<section class="py-20 bg-gradient-to-b from-slate-50 to-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight"><?php echo e(__('ui.recommended_hotels')); ?></h2>
                <p class="text-slate-400 text-sm mt-1.5"><?php echo e(__('ui.hotels_sub')); ?></p>
            </div>
            <a href="<?php echo e(route('hotels')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5 shrink-0 group">
                <?php echo e(__('ui.view_all_hotels')); ?>

                <i class="fas fa-arrow-right text-xs transition-transform group-hover:translate-x-0.5"></i>
            </a>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredHotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:shadow-blue-900/[0.06] hover:-translate-y-1 transition-all duration-500 group">
                <div class="relative h-48 overflow-hidden">
                    <img src="<?php echo e($hotel->image_url); ?>"
                ...
                <div class="p-5">
                    <h3 class="font-bold text-slate-900 text-[15px] mb-1.5 line-clamp-1 group-hover:text-blue-600 transition-colors"><?php echo e($hotel->name); ?></h3>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hotel->city || $hotel->address): ?>
                    <p class="text-xs text-slate-400 flex items-center gap-1.5">
                        <i class="fas fa-map-marker-alt text-blue-400 text-[10px]"></i>
                        <?php echo e($hotel->city ?? $hotel->address); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($instagramFeeds->count() > 0): ?>
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $instagramFeeds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="aspect-square rounded-2xl overflow-hidden group">
                <a href="<?php echo e($feed->permalink); ?>" target="_blank" class="block w-full h-full relative">
                    <img src="<?php echo e($feed->image_url); ?>" alt="<?php echo e($feed->caption); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 ease-out">
        ...
        <div class="text-center mt-10">
            <a href="https://instagram.com/<?php echo e($settings['instagram_username'] ?? 'northsumateratrip'); ?>" target="_blank"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6 text-center">
            ...
            <div class="text-white group">
                <div class="w-14 h-14 bg-white/10 border border-white/10 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-white/20 group-hover:scale-110 transition-all duration-500">
                    <i class="fas <?php echo e($feature['icon']); ?> text-lg"></i>
                </div>
                <h3 class="font-bold text-sm mb-1.5"><?php echo e($feature['title']); ?></h3>
                <p class="text-blue-200/80 text-xs leading-relaxed max-w-[180px] mx-auto"><?php echo e($feature['desc']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<section class="py-14 bg-white">
    <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <a href="<?php echo e(route('custom-request.create')); ?>"
           class="group flex flex-col md:flex-row items-center justify-between gap-8 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-800 rounded-3xl px-8 md:px-12 py-10 shadow-2xl shadow-blue-500/20 hover:shadow-blue-500/30 transition-all duration-300 relative overflow-hidden">
            ...
            <div class="relative text-center md:text-left">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-white tracking-tight mb-2"><?php echo e(__('ui.custom_trip')); ?></h2>
                <p class="text-blue-100 text-sm max-w-lg"><?php echo e(__('ui.custom_trip_sub')); ?></p>
                <div class="flex flex-wrap justify-center md:justify-start gap-3 mt-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [__('ui.why_flexible'), __('ui.why_budget'), __('ui.why_personal')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="flex items-center gap-1.5 px-3 py-1.5 bg-white/10 border border-white/20 rounded-xl text-white text-xs font-semibold">
                        <i class="fas fa-check text-xs"></i><?php echo e($tag); ?>
...
<section class="py-20 bg-white">
    <div class="max-w-3xl mx-auto px-6 overflow-hidden">
        <div class="text-center mb-14">
            ...
            <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight mb-2"><?php echo e(__('ui.faq_title')); ?></h2>
            <p class="text-slate-400 text-sm"><?php echo e(__('ui.faq_sub')); ?></p>
        </div>
        ...
        <div class="space-y-3" x-data="{ active: null }">
            ...
            <div class="border border-slate-100 rounded-2xl overflow-hidden transition-all duration-500" :class="active === <?php echo e($index); ?> ? 'shadow-lg shadow-blue-900/[0.04] border-blue-100' : 'hover:border-slate-200'">
                <button @click="active = (active === <?php echo e($index); ?> ? null : <?php echo e($index); ?>)" 
                        class="w-full flex items-center justify-between p-5 md:p-6 text-left transition-colors duration-300" :class="active === <?php echo e($index); ?> ? 'bg-blue-50/50' : 'bg-white hover:bg-slate-50/50'">
                    <span class="font-bold text-sm pr-4 transition-colors duration-300" :class="active === <?php echo e($index); ?> ? 'text-blue-700' : 'text-slate-900'"><?php echo e($faq['q']); ?></span>
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300" :class="active === <?php echo e($index); ?> ? 'bg-blue-100 text-blue-600 rotate-180' : 'bg-slate-100 text-slate-400'">
...
<section class="py-20 bg-slate-950 relative overflow-hidden">
    ...
    <div class="max-w-2xl mx-auto px-5 sm:px-6 text-center relative z-10">
        ...
        <h2 class="text-2xl md:text-4xl font-extrabold text-white tracking-tight mb-4">
            <?php echo e(\App\Models\Setting::get('cta_title', 'Siap Memulai Petualangan?')); ?>

        </h2>
        <p class="text-slate-400 text-sm mb-10 leading-relaxed max-w-lg mx-auto">
            <?php echo e(\App\Models\Setting::get('cta_subtitle', 'Hubungi kami sekarang untuk konsultasi perjalanan gratis.')); ?>

        </p>
        <div class="flex flex-col sm:flex-row justify-center gap-3">
            <a href="https://wa.me/<?php echo e(preg_replace('/\D/', '', \App\Models\Setting::get('whatsapp_number', '6281298622143'))); ?>"
               target="_blank"
               class="inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm rounded-2xl transition-all duration-300 hover:scale-[1.03] shadow-xl shadow-emerald-900/30">
                <i class="fab fa-whatsapp text-lg"></i>
                <?php echo e(\App\Models\Setting::get('cta_button_text', 'Hubungi Kami')); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROYEK\WISATA SEDERHANA\northsumateratrip.com\resources\views/pages/home.blade.php ENDPATH**/ ?>